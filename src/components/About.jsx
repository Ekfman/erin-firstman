    ...
    <div className="aboutMe">
      <div className="about_me_container">
        <div className="about_me_content">
          <p>
            My career originally began in Marketing. Working with website UI in
            my previous roles, I became fascinated by computer-to-human
            interaction and enrolled in an accelerated Software Development
            program to learn the PERN (PostgreSQL, Express, React, Node) stack.
          </p>
        </div>
        <div className="about_me_content">
          <p>
            With my background in Marketing, I can bring a unique perspective to
            the Software Development team -one that allows me to understand user
            needs, identify market trends, and effectively communicate across
            departments.
          </p>
        </div>
      </div>
      <div className="about_me_btns_container">
        <div className="about_me_btns">
          ...
          <div className="techWrapper">
            ...
            <div className="icon_and_name">
              <img className="techIcon" alt="React icon" src={reactIcon}></img>
              <p>React</p>
            </div>
            <div className="icon_and_name">
              <img
        ...
        <div className="about_me_btns" style={{ borderLeft: '2px solid #21d4fd', borderRight: '2px solid #21d4fd' }}>
