  ...
  return (
    <div className="parentContainer" id="about">
      <div className="intro">
        ...
        <h1 className="banner">
          My name is <span className="cursiveFont">Erin Firstman</span> and I am
          a full-stack <span>software developer</span>.
        </h1> */}
      </div>
      <div className="imgBio">
        ...
        <div>
          ...
          <p>
            ...
            learning the PERN stack (postgreSQL, Express.js, React.js, Node.js)
